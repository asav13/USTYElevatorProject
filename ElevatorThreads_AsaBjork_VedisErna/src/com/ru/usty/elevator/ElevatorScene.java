...
public class ElevatorScene {
	/**
	* Finally make sure that every person thread calls personExitsAtFloor(floor) 
	* with the correct value of floor when it gets out of the elevator, before it finishes.
	*/
